        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Rekap Gaji Per Tahun Keseluruhan</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p>Berikut Gaji Keseluruhan Per Tahun</p>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row=mysqli_fetch_assoc($result)){?>                                            
                                                <tr>
                                                    <td><?= $no; ?></td>
                                                    <td>
                                                        <a href="rekap-gaji-bulan.php?tahun=<?php echo $row["tahun"]; ?>" class="btn btn-success btn-xs mr-1"><i class="fa fa-eye"></i> Per Bulan</a>
                                                    </td>
