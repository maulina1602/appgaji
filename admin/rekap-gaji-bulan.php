        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Rekap Gaji Per Bulan Tahun <?= $tahun; ?></h1>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row=mysqli_fetch_assoc($result)){?>                                            
                                                <tr>
                                                    <td><?= $no; ?></td>
                                                    <td>
                                                        <a href="rekap-gaji-karyawan.php?bulan=<?php echo $row["bulan"]; ?>&tahun=<?php echo $tahun; ?>" class="btn btn-success btn-xs mr-1"><i class="fa fa-eye"></i> Per Karyawan</a>
                                                    </td>
