                                ...
                                <form action="" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo $row_bagian["nama_bagian"]; ?>"
                                            placeholder="Nama Bagian/Bidang" required>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="karyawan_id" name="karyawan_id" required>
                                                ...
                                                <?php if (!(strcmp($row_karyawan['id'], htmlentities($row_bagian['karyawan_id'],
                                                ENT_COMPAT, 'utf-8')))) {
                                                echo "SELECTED";
                                                }?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="lokasi_id" name="lokasi_id" required>
                                                ...
                                                while ($row_lokasi = mysqli_fetch_assoc($result_lokasi)) {
                                                    ?>
                                                <option value="<?php echo $row_lokasi["id"]; ?>"
                                                <?php if (!(strcmp($row_lokasi['id'], htmlentities($row_bagian['lokasi_id'],
                                                ENT_COMPAT, 'utf-8')))) {
                                                echo "SELECTED";
                                                }?>>
